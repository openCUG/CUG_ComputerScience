...
def setup_training_loop_kwargs(
    ...
    try:
        ...
        # sunhui
        args.training_set_kwargs.max_size = 10000 #len(training_set) # be explicit about dataset size
    ...
    cfg_specs = {
        'auto':      dict(ref_gpus=-1, kimg=25000,  mb=-1, mbstd=-1, fmaps=-1,  lrate=-1,     gamma=-1,   ema=-1,  ramp=0.05, map=8), # 2 Populated dynamically based on resolution and GPU count.
...
def do_parser():
    ...
    parser.add_argument('--outdir', help='Where to save the results',default=r'./runs/', metavar='DIR')  # required=True,
    parser.add_argument('--gpus', help='Number of GPUs to use ',default= 1, type=int, metavar='INT')
    parser.add_argument('--snap', help='Snapshot interval ',default=50, type=int, metavar='INT')
    ...
    # Dataset.
    parser.add_argument('--data', help='Training data (directory or zip)', default= r'./dataset_ready',
                  metavar='PATH')  # , required=True
    parser.add_argument('--cond', help='Train conditional model based on dataset labels', default= False, type=bool,
                  metavar='BOOL')
    ...
    parser.add_argument('--augpipe', help='Augmentation pipeline', default= 'bgc', type=click.Choice(
    ...
    parser.add_argument('--freezed', help='Freeze-D', default= 0, type=int, metavar='INT')
    # Performance options.
...
# @click.option('--outdir', help='Where to save the results', default=r'./runs/', metavar='DIR')  # required=True,
# @click.option('--gpus', help='Number of GPUs to use ', default=1, type=int, metavar='INT')
# @click.option('--snap', help='Snapshot interval ', default=50, type=int, metavar='INT')
# @click.option('--metrics', help='Comma-separated list or "none" ', default='fid50k_full', type=CommaSeparatedList())
# @click.option('--seed', help='Random seed', default=0, type=int, metavar='INT')
# @click.option('-n', '--dry-run', help='Print training options and exit', is_flag=True)
# # Dataset.
# @click.option('--data', help='Training data (directory or zip)', default=r'./dataset_ready',
#               metavar='PATH')  # , required=True
...
# @click.option('--freezed', help='Freeze-D', default=0, type=int, metavar='INT')
# # Performance options.
...
# General options.
@click.option('--outdir', help='Where to save the results [default: ./runs/]',default=r'./runs/', metavar='DIR') #required=True,
@click.option('--gpus', help='Number of GPUs to use [default: 1]', type=int, metavar='INT')
...
# Dataset.
@click.option('--data', help='Training data (directory or zip) ',default= r'generated_imgs/ffhq_256x256', metavar='PATH')#, required=True
@click.option('--cond', help='Train conditional model based on dataset labels [default: false]', type=bool, metavar='BOOL')
@click.option('--subset', help='Train with only N images [default: all]', type=int, metavar='INT')
@click.option('--mirror', help='Enable dataset x-flips [default: false]', type=bool, metavar='BOOL')

# Base config.
@click.option('--cfg', help='Base config [default: auto]',default='paper512', type=click.Choice(['auto', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar']))
@click.option('--gamma', help='Override R1 gamma', type=float)
@click.option('--kimg', help='Override training duration', type=int, metavar='INT')
@click.option('--batch', help='Override batch size', type=int, metavar='INT')
