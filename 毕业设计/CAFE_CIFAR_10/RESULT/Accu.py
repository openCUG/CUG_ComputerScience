...
txt1 = 'VFL_cafe_cifar10_0.01.txt'
txt2 = 'VFL_cafe_cifar10_0.01_defense.txt'
...
# ax.plot(table1[2], table1[1], label='linear') # 作y1 = x 图，并标记此线名为linear
# ax.plot(table2[2], table2[1], label='quadratic') #作y2 = x^2 图，并标记此线名为quadratic
